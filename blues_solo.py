...
licks = [ [ [1,0.5*.9], [1,0.5*1.1], [1, 0.5*.9], [1, 0.5*1.1] ],[ [-1, 0.5*.9], [-1, 0.5*1.1], [-1, 0.5*.9], [-1, 0.5*1.1] ],
[[2,0.5*.9],[-1,0.5*1.1],[2,0.5*.9],[-3,0.5*1.1]], [[-2,0.5*.9],[1,0.5*1.1],[-2,0.5*.9],[3,0.5*1.1]],[[1,0.5*.9],[-2,0.5*1.1],[1,0.5*.9],[0,0.5*1.1]],
[[1,0.5*.9],[-1,0.5*1.1],[1,0.5*.9],[-1,0.5*1.1]]]
...
for i in range(24):
    ...
    for note in lick:
        curr_note += note[0]
        if curr_note<0:
        	curr_note=random.randint(0,5)

        if curr_note>len(blues_scale):
        	curr_note=random.randint(len(blues_scale)-5,len(blues_scale))
